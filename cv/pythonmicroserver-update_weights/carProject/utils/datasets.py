...
from carProject.utils.utils import xyxy2xywh, xywh2xyxy
...
# class LoadImages:  # for inference
#     def __init__(self, binary_array, img_size=416):
#         self.img_size = img_size
...
class LoadImages(Dataset):  # for inference
    def __init__(self, binary_array_list, img_size=416):
        self.img_size = img_size
        self.binary_array_list = binary_array_list
    ...
    def __getitem__(self, item_index):
        ...
        img0 = self.binary_array_list[item_index]
    ...
    def __len__(self):
        return len(self.binary_array_list)  # number of files
